 ...
 * Robin Keskisärkkä
 *
 * This class was copied and extended from LangTriG in order to support non-braced triples where
 * the subject is an embedded triple.
 */
 ...
 */
public class LangTriGExt extends LangTurtleBase {

    public LangTriGExt(Tokenizer tokens, ParserProfile profile, StreamRDF dest) {
    ...
    protected final void oneNamedGraphBlock2() {
         ...
         *
         **/
         if ( lookingAt(KEYWORD) && !EmbeddedTripleTokenUtils.isEmbeddedTripleToken(token) ) {
