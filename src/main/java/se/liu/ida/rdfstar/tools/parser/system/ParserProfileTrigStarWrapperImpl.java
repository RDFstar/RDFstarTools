...
/**
 * A {@link ParserProfileTrigStar} implemented as
 * a wrapper of some other {@link ParserProfile}.
 * 
 * @author Robin Keskisärkkä
 */
public class ParserProfileTrigStarWrapperImpl implements ParserProfileTrigStar
{
	final protected ParserProfile profile;

	public ParserProfileTrigStarWrapperImpl(final ParserProfile profile ) {
    ...
    public Node create(Node currentGraph, Token token) {
    	if ( EmbeddedTripleTokenUtils.isEmbeddedTripleToken(token) )
    		return Helper.createTripleNodeFromEmbeddedTripleToken(
